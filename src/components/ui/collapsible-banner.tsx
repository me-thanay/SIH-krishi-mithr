    ...
    <>
      ...
      >
        <div
          ...
          className={`rounded-[11px] border border-emerald-100 bg-white shadow-[0_1px_2px_rgba(28,25,23,0.06),0_4px_10px_-8px_rgba(16,185,129,0.18)] ${className}`}
        >
          <div className="flex items-center gap-2.5 p-2.5">
            <span
              aria-hidden="true"
              className="grid size-[26px] shrink-0 place-items-center rounded-[7px] bg-emerald-50 text-emerald-700 shadow-[inset_0_1px_2px_rgba(16,185,129,0.12)]"
            >
              {icon ?? NOTICE_GLYPH}
            </span>
            ...
            {hasBody ? (
              <button
                ...
                className="group flex min-w-0 flex-1 items-center gap-2 rounded-[7px] text-left outline-none focus-visible:bg-emerald-50 focus-visible:shadow-[inset_0_0_0_1px_#10b981]"
              >
                <span
                  id={titleId}
                  className="min-w-0 flex-1 truncate text-[13px] font-medium leading-5 text-stone-800"
                >
                  {title}
                </span>
                <motion.span
                  aria-hidden="true"
                  className="flex shrink-0 text-stone-400 group-hover:text-stone-600"
                  initial={false}
            ...
            {dismissible ? (
              <button
                ...
                className="grid size-[26px] shrink-0 place-items-center rounded-[7px] text-stone-400 transition-colors duration-150 hover:bg-stone-100 hover:text-stone-700 focus-visible:outline-none focus-visible:bg-emerald-50 focus-visible:shadow-[inset_0_0_0_1px_#10b981]"
              >
                {CLOSE}
              </button>
            ) : null}
