...
export function VoiceChat({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center bg-background relative overflow-hidden rounded-2xl",
        "border border-border/80 p-6 md:p-8",
        className
      )}
    >
      {/* Ambient particles */}
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <motion.button
            ...
            whileHover={!isListening && !isProcessing && !isSpeaking ? { scale: 1.05 } : {}}
            whileTap={!isListening && !isProcessing && !isSpeaking ? { scale: 0.95 } : {}}
          >
          ...
          <motion.div
            className={cn(
              ...
              isListening
                ...
                : isProcessing
                ? "border-yellow-500 shadow-lg shadow-yellow-500/25 bg-yellow-50"
                : isSpeaking
                ? "border-green-500 shadow-lg shadow-green-500/25 bg-green-50"
          ...
          >
            <AnimatePresence mode="wait">
              {isProcessing ? (
                ...
                >
                  <Loader2 className="w-10 h-10 md:w-12 md:h-12 text-yellow-500 animate-spin" />
                </motion.div>
              ) : isSpeaking ? (
                <motion.div
                  key="speaking"
                  ...
                  exit={{ opacity: 0, scale: 0.8 }}
                >
                  <Volume2 className="w-10 h-10 md:w-12 md:h-12 text-green-500" />
                </motion.div>
              ) : isListening ? (
                <motion.div
                  key="listening"
                  ...
                  exit={{ opacity: 0, scale: 0.8 }}
                >
                  <Mic className="w-10 h-10 md:w-12 md:h-12 text-blue-500" />
                </motion.div>
              ) : (
                <motion.div
                  key="idle"
                  ...
                  exit={{ opacity: 0, scale: 0.8 }}
                >
                  <Mic className="w-10 h-10 md:w-12 md:h-12 text-muted-foreground" />
                </motion.div>
              )}
            </AnimatePresence>
          </motion.div>
        ...
        {/* Waveform visualizer */}
        <div className="flex items-center justify-center space-x-1 h-14 md:h-16">
